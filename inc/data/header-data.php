...
if ( ! function_exists( 'grv_css_include' ) ) {
  function grv_css_include () { 
    ...
    wp_enqueue_style( 'grv-style', get_template_directory_uri() . '/css/main.min.css', array('grv-vendor'), 'v1.0', 'all' );
...
if ( ! function_exists( 'grv_scripts_include' ) ) { 
  function grv_scripts_include() {
    ...
    wp_register_script( 'grv-main', get_template_directory_uri().'/scripts/main.js', array( 'jquery' ), 'v1.1', 'footer' );
    wp_register_script( 'grv-main1', get_template_directory_uri().'/lib/jquery/dist/jquery.js', array( 'jquery' ), 'v1.1', 'footer' );
