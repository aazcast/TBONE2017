...
new WPUpdatesThemeUpdater_1978( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_1978') ) {
    class WPUpdatesThemeUpdater_1978 {
